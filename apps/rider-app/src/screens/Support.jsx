...
function Support() {
  ...
  const handleSubmitDispute = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://ride-hailing-backend-coan.onrender.com/api/users/disputes",
        {
  ...
  const faqs = [
    {
      id: 1,
      question: "I lost an item during my ride. What should I do?",
      answer:
        "You can contact your driver directly up to 24 hours after the ride ends via the Ride History page. If you are unable to reach them, please use the Contact Support button below.",
    },
    {
      id: 2,
      question: "How do I dispute a cancellation fee?",
      answer:
        "Cancellation fees are applied if you cancel 5 minutes after a driver accepts. To dispute a fee, go to Ride History, select the specific ride, and tap 'Help with this ride'.",
    },
    {
      id: 3,
      question: "My payment failed. How can I clear my balance?",
      answer:
        "Navigate to the Payments screen from the sidebar. You will see an option to clear any outstanding balances using an alternative payment method.",
    },
  ];
                ...
                {faqs.map((faq) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <svg
                        className={`w-5 h-5 text-brand-teal dark:text-brand-mint transform transition-transform duration-200 ${expandedFaq === faq.id ? "rotate-180" : ""}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
