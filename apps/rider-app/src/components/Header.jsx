...
const Header = () => {
  ...
  const handleLogout = () => {
    logout(); // 1. Clear token and state
    navigate("/login"); // 2. Kick them back to the login screen
  };
  return (
    <>
      <header
        className="sticky top-0 z-50 flex items-center justify-between px-4 py-3 md:px-8 
      ...
      >
        ...
        {/* App Logo / Title */}
        <h1 className="text-2xl font-black tracking-wider text-brand-teal dark:text-brand-mint">
          RIDE
        </h1>
